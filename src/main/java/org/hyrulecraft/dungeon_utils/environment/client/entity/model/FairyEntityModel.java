...
public class FairyEntityModel extends EntityModel<FairyEntity> {
	...
	public static @NotNull TexturedModelData getTexturedModelData() {
		...
		main.addChild("cube_r1", ModelPartBuilder.create().uv(7, 21).cuboid(0.3725F, -3.5F, 2.163F, 0.0F, 1.0F, 1.2F, new Dilation(0.0F))
		...
		main.addChild("cube_r2", ModelPartBuilder.create().uv(7, 21).cuboid(0.0F, -1.5F, -1.495F, 0.0F, 1.0F, 1.2F, new Dilation(0.0F))
