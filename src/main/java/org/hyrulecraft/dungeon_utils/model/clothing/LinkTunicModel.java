...
public class LinkTunicModel extends BipedEntityModel<LivingEntity> {
	...
	public static TexturedModelData getTexturedModelData() { // TODO: fix the arms, currently using a mix of this model and an armour chestplate.
		...
		ModelPartData cube_r1 = body.addChild("cube_r1", ModelPartBuilder.create().uv(12, 32).cuboid(-4.0F, -8.0F, 1.0F, 4.0F, 4.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(-4.2F, 18.3F, 2.0F, 0.0F, -1.5708F, 0.1571F));
		ModelPartData cube_r2 = body.addChild("cube_r2", ModelPartBuilder.create().uv(24, 4).cuboid(-4.0F, -8.0F, 1.0F, 4.0F, 4.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(6.2F, 18.0F, 2.0F, 0.0F, -1.5708F, -0.1571F));
		ModelPartData cube_r3 = body.addChild("cube_r3", ModelPartBuilder.create().uv(40, 24).cuboid(-4.0F, -4.0F, 1.0F, 8.0F, 4.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 14.35F, 1.6F, 0.1571F, 0.0F, 0.0F));
		ModelPartData cube_r4 = body.addChild("cube_r4", ModelPartBuilder.create().uv(40, 28).cuboid(-4.0F, -8.0F, 1.0F, 8.0F, 4.0F, 0.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 18.0F, -4.1F, -0.1571F, 0.0F, 0.0F));
