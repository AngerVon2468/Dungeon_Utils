...
object DungeonUtilsItems {
    ...
    @JvmField
    val PARAGLIDER = registerItem("paraglider",
        ParagliderTrinketItem(
            FabricItemSettings().maxCount(1).maxDamage(0)
        )
    )

    @JvmField
    val MOGMA_MITTS = registerItem("mogma_mitts",
        MogmaMittsItem(
            FabricItemSettings().maxCount(1).maxDamage(0)
        )
    )
    ...
    @JvmField
    val CLIMBING_GLOVES = registerItem("climbing_gloves",
        ClimbingGlovesItem(
            FabricItemSettings().maxCount(1).maxDamage(0)
        )
    )
    ...
    @JvmField
    val LYNEL_BOW_FIVE_X = registerItem("lynel_bow_five_x",
        LynelBowFiveXItem(
            FabricItemSettings().maxDamage(1024)
        )
    )

    @JvmField
    val LYNEL_BOW_THREE_X = registerItem("lynel_bow_three_x",
        LynelBowThreeXItem(
            FabricItemSettings().maxDamage(1024)
        )
    )
    ...
    @JvmField
    val REVALIS_GALE = registerItem("revalis_gale",
        RevalisGaleItem(
            CHAMPION_ABILITY
        )
    )
    ...
    @JvmField
    val REVALIS_GALE_PLUS = registerItem("revalis_gale_plus",
        RevalisGalePlusItem(
            CHAMPION_ABILITY
        )
    )
    ...
    @JvmField
    val MIPHAS_GRACE = registerItem("miphas_grace",
        MiphasGraceItem(
            CHAMPION_ABILITY
        )
    )
    ...
    @JvmField
    val MIPHAS_GRACE_PLUS = registerItem("miphas_grace_plus",
        MiphasGracePlusItem(
            CHAMPION_ABILITY
        )
    )
    ...
    @JvmField
    val DARUKS_PROTECTION = registerItem("daruks_protection",
        DaruksProtectionItem(
            CHAMPION_ABILITY
        )
    )

    @JvmField
    val LINK_CAP = registerItem("link_cap",
        CapTrinketItem(
            FabricItemSettings().maxCount(1).maxDamage(0)
        )
    )
    ...
    @JvmField
    val LINK_TUNIC = registerItem("link_tunic",
        TunicTrinketItem(
            FabricItemSettings().maxCount(1).maxDamage(0)
        )
    )
    ...
    @JvmField
    val THE_MASTER_SWORD = registerItem("the_master_sword",
        MasterSwordItem(
            ToolMaterials.DIAMOND,
            12,
            -1.8f,
            FabricItemSettings().maxDamage(2048)
        )
    )

    @JvmField
    val THE_MASTER_SWORD_AWAKENED = registerItem("the_master_sword_awakened",
        MasterSwordItem(
            ToolMaterials.DIAMOND,
            14,
            -1.8f,
            FabricItemSettings().maxDamage(4096)
        )
    )
    ...
    @JvmField
    val HEART_CONTAINER = registerItem("heart_container",
        HeartContainerItem(
            FabricItemSettings().maxCount(1).maxDamage(0)
        )
    )
    ...
    @JvmField
    val GREAT_EAGLE_BOW = registerItem("great_eagle_bow",
        GreatEagleBowItem(
            FabricItemSettings().maxDamage(1500)
        )
    )
    ...
    @JvmField
    val CHILD_RUPEE_WALLET = registerItem("child_rupee_wallet",
        ChildRupeeWalletItem(
            FabricItemSettings().maxCount(1).maxDamage(0)
        )
    )
    ...
    @JvmField
    val HOOKSHOT = registerItem("hookshot",
        HookshotItem(
    ...
    @JvmField
    val SHEIKAH_SLATE = registerItem("sheikah_slate",
        SheikahSlateItem(
